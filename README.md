...
## Business context
The Waves salon has been on the market for six months, occupying the niche of serving clients with curly hairstyles. Like any business, they are focused on increasing profitability. Their reporting is managed manually in Google Sheets, and they provided us with transaction data across six months of operation. The goal is to analyze the structure of income and expenses: how much is spent on operations, what revenue is generated, the main expense categories, and the key sources of income. <br/>
...
<img width="870" height="514" alt="Lowest-performing promo campaigns by lost revenue (1)" src="https://github.com/user-attachments/assets/c22a5052-532a-4312-abcb-38ecf525cc9a" />
